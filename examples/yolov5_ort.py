...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=r'D:\Work_space\vscode\DeepLearning\yolov5-projects\yolov5_detection_project\models\best.onnx', help='onnx path(s)')
    parser.add_argument('--img', type=str, default='0', help='source')  # file/folder, 0 for webcam
